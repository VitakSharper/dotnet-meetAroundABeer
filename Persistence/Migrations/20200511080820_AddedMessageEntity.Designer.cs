...
namespace Persistence.Migrations
{
    ...
    [Migration("20200511080820_AddedMessageEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Like", b =>
                {
                    b.HasOne("Domain.Identity.AppUser", "Likee")
                        .WithMany("Likers")
                        .HasForeignKey("LikeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Identity.AppUser", "Liker")
                        .WithMany("Likees")
            ...
            modelBuilder.Entity("Domain.Message", b =>
                {
                    b.HasOne("Domain.Identity.AppUser", "Recipient")
